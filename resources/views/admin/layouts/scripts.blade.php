 <!-- jQuery 2.2.0 -->
 <script src="{{ asset('adminpanel/plugins/jQuery/jQuery-2.2.0.min.js') }}"></script>
 <!-- jQuery UI 1.11.4 -->
 ...
 <!-- jvectormap -->
 <script src="{{ asset('adminpanel/plugins/jvectormap/jquery-jvectormap-1.2.2.min.j') }}s"></script>
