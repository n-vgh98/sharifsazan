...
class WriterCourseController extends Controller
{
    ...
    {
        $courses = Course::all();
        return view("writer.courses.all", compact("courses"));
    }
    ...
    public function online()
    {
        ...
        return view("writer.courses.online", compact("courses"));
    }
    ...
    public function offline()
    {
        ...
        return view("writer.courses.offline", compact("courses"));
    }
    ...
    public function free()
    {
        ...
        return view("writer.courses.free", compact("courses"));
    }
    ...
    {
        $courses = Course::where("price", ">", 0)->get();
        return view("writer.courses.notfree", compact("courses"));
    }
    ...
    public function edit($id)
    {
        ...
        return view("writer.courses.edit", compact("course"));
    }
